...
:::note
2025-12-05 :clinking_glasses:: Fixed the viscosity issue! Viscosity occurs when particles adopt their neighbours' velocities. The origin was a bug in `reset_velocity_field()` which initialised interpolation weights to `1.f` instead of `0.f`. This likely wasn't caught because this was expected behaviour in a previous revision. I must've missed changing it after moving to FLIP.
:::
